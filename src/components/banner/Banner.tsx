...
const Banner: React.FC = () => {
  ...
  return (
    <section className="bg-no-repeat bg-cover bg-center">
      ...
      <div className="absolute top-0 lg:mx-auto left-0 right-0 mx-0 max-w-[1200px]">
        <nav className="xl:mx-auto xl:px-0 md:px-8 px-4">
          <div className=" w-full md:w-[98%]">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute right-0 flex items-center sm:hidden">
                ...
                <button
                  type="button"
                  className="relative inline-flex items-center justify-center rounded-md p-2 text-white hover:bg-transparent hover:text-white outline-none"
                ...
                <div className="relative ml-3">
                  <div className="hidden sm:ml-6 sm:block">
                    <div className="flex space-x-4 justify-end items-center">
                      ...
                      <span className='border-r border-[rgba(255, 255, 255, 0.50);] h-[13px]'></span>
       ...
       {openModal && <div className="sm:hidden absolute top-15 w-full bg-gradient-to-r from-[#153F38] to-[#305D52]" id="mobile-menu">
        ...
        <div className="xl:mx-auto xl:px-0 md:px-8 px-4 max-w-[1200px] w-full md:w-[98%] w-full flex lg:gap-24 gap-0 flex-wrap lg:flex-nowrap md:justify-between justify-center">
          <div className="lg:w-[50%] md:w-[75%] w-full md:mx-auto lg:pt-[100px] md:pt-[56px] pt-[44px]">
            <h1 className="text-white md:text-[64px] text-[36px] lg:mb-[12px] mb-[16px] font-bold md:leading-[72px] leading-1 text-center lg:text-left">
              <span className="bordered-text">GET AN</span>
              <br /> INTERVENTION
            </h1>
            <p className="lg:text-sm md:text-[18px] text-[14px] md:mb-0 mb-3 text-white font-light !leading-loose lg:text-left text-center">
